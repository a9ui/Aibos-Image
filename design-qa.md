...
5. P2: fixed minimum dimensions and header density could clip Settings, sidebars, scrollbars, buttons, or the drag surface on compact work areas. Fix: derive effective minimums from the active work area, wrap sidebar content, constrain search, and preserve the drag region. Post-fix evidence: monitor-work-area smoke passes wide, compact, short, Japanese, maximize, restore, and offscreen normalization cases.
